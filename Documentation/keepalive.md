...
https://godoc.org/github/mchirico/grpc/keepalive for the options.

## What should I set?

It should be sufficient for most users to set [client
parameters](https://godoc.org/github/mchirico/grpc/keepalive) as a [dial
option](https://godoc.org/github/mchirico/grpc#WithKeepaliveParams).
...
parameters](https://godoc.org/github/mchirico/grpc/keepalive#ServerParameters)
for details.

### Enforcement policy

[Enforcement
policy](https://godoc.org/github/mchirico/grpc/keepalive#EnforcementPolicy) is
